# Простейший парсер фанфиков с сайта fanfics.me
# Использует десктопную версию сайта для сбора информации
# и мобильную для получения текста фанфиков
# Требования: Python 3, BeautifulSoup4, html5lib
# Версия 0.2 / 15.06.2017
